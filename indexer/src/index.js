// valdium-indexer · Entrypoint. Boots the SQLite store, starts the HTTP
...
const RPC_URL = process.env.RPC_URL || 'https://testnet.valdium.xyz';
...
console.log('[boot] valdium-indexer');
