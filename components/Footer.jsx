// valdium-explorer · Page footer. Network info plus links to the
  ...
  return (
    <footer className="dash-border-t mt-20">
      <div className="px-[6%] py-10 grid grid-cols-1 md:grid-cols-4 gap-6">
        <div>
          <p className="font-plus font-bold text-white text-[14px] mb-2">Valdium Explorer</p>
        ...
        <div>
          ...
          <ul className="space-y-2 font-dm-mono text-[12px]">
            <li><a href="https://valdium.xyz" className="text-[#A1A1A6] hover:text-white">valdium.xyz →</a></li>
            <li><a href="https://valdium.xyz/docs" className="text-[#A1A1A6] hover:text-white">Docs →</a></li>
            <li><a href="https://x.com/valdium_node" className="text-[#A1A1A6] hover:text-white">X / Twitter →</a></li>
            <li><a href="https://t.me/valdium" className="text-[#A1A1A6] hover:text-white">Telegram →</a></li>
          </ul>
        </div>
      </div>
      <div className="dash-border-t px-[6%] py-4">
        <p className="font-dm-mono text-[10px] text-[#5A5A5A]">© Valdium {new Date().getUTCFullYear()}</p>
      </div>
    </footer>
  );
}
